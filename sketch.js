...
function pinkCyclists(){
        player1 =createSprite(1100,Math.round(random(50, 630)));
        player1.scale =0.06;
...
function yellowCyclists(){
        player2 =createSprite(1100,Math.round(random(50, 630)));
        player2.scale =0.06;
...
function redCyclists(){
        player3 =createSprite(1100,Math.round(random(50, 630)));
        player3.scale =0.06;
...
function obstacles(){
    ...
    if(select_obstacles == 1){
        obstacle1 = createSprite(1100,Math.round(random(50,630)));
    ...
    if(select_obstacles == 2){
      obstacle2 = createSprite(1100,Math.round(random(50,630)));
  ...
  if(select_obstacles == 3){
    obstacle3 = createSprite(1100,Math.round(random(50,630)));
    obstacle3.scale = 0.06;
    obstacle3.addImage("obstacle3",obstacle1Img);
    obstacle3.velocityX = -(6 + 2*distance/150);
}     
   obst.add(obstacle1,obstacle2,obstacle3);
   obst.setLifetimeEach = 170;
}
